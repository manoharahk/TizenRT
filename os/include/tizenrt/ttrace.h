...
///@file tizenrt/ttrace.h
///@brief ttrace APIs

#ifndef __INCLUDE_TIZENRT_TTRACE_H
#define __INCLUDE_TIZENRT_TTRACE_H
 ...
 * @details @b #include <tizenrt/ttrace.h>
...
#endif /* CONFIG_TTRACE */
#endif /* __INCLUDE_TIZENRT_TTRACE_INTERNAL_H */
/**
 * @}
 */
